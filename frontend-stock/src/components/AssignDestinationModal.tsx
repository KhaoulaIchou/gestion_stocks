...
const COMPONENTS_CA = [
  ...
  "Parquet général",
  "Greffe",
  "Chambre du statut personnel et des successions",
  "Chambre correctionnelle de première instance",
  "Chambre correctionnelle d’appel",
  "Chambre civile",
  "Chambre immobilière",
  "Chambre sociale",
  "Chambre pénale",
  "Chambre des affaires publiques",
